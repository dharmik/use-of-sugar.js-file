(function() {
    ...
    function pa(a, b, c, d) {
        ...
        I(b.SugarMethods, function(b, c) {
            (e || -1 !== g.indexOf(b)) && (f = !0, d(c.instance ? a.prototype : a, b, c));
        });
        return f;
    }
    function qa(a, b, c) {
    ...
    function L(a, b, c) {
        ...
        c = c || 0;
        var e;
        for (e = a.length; e > c; c++) d.push(a[c]), b && b.call(a, a[c], c);
        return d;
    }
    function sa(a, b, c) {
        var d = a[c || 0];
    ...
    function ya(a) {
        ua(a) && (a = m(a));
        if (ga && z(a)) for (var d, b = a, c = 0; d = b.charAt(c); ) b[c++] = d;
        return a;
    }
    function O(a) {
        xa(this, ya(a));
    ...
    function Na(a, b) {
        var c = "";
        for (a = a.toString(); b > 0; ) (1 & b && (c += a), b >>= 1) && (a += a);
        return c;
    }
    function Oa(a, b) {
        var c, d;
    ...
    function Ta(a, b) {
        ...
        if (null != a && d || e) {
            b || (b = []);
            if (b.length > 1) for (l = b.length; l--; ) if (b[l] === a) return "CYC";
            b.push(a);
            d = a.valueOf() + s(a.constructor);
            f = e ? a : m.keys(a).sort();
            l = 0;
            for (n = f.length; n > l; l++) h = e ? l : f[l], d += h + Ta(a[h], b);
            b.pop();
        } else d = -1/0 === 1 / a ? "-0" : s(a && a.valueOf ? a.valueOf() : a);
        return c + g + d;
    }
    function Ua(a, b) {
    ...
    function bb(a, b, c, d) {
        ...
        ta(b);
        if (0 == e && !f) throw new TypeError("Reduce called on empty array with no initial value");
        f || (c = a[d ? e - 1 : g], g++);
        for (;e > g; ) f = d ? e - g - 1 : g, f in a && (c = b(c, a[f], f, a)), g++;
        return c;
    }
    function cb(a) {
    ...
    function mb(a, b, c, d, e, g) {
        var f, h, l;
        a.length > 0 && (l = ib(b), V(a, function(b, c) {
    ...
    function pb(a, b, c) {
        ...
        a.each(function(a) {
            ...
            if (qb(e, b, a, h) !== c) {
                var l = 0;
                if (h) for (b = e[b]; b.length > l; ) b[l] === a ? b.splice(l, 1) : l += 1; else delete e[b];
                d.push(a);
            }
        });
        return d;
    ...
    function rb(a, b, c) {
        ...
        var d = [];
        V(a, function(a) {
            A(a) && b > c ? d = d.concat(rb(a, b, c + 1)) : d.push(a);
        });
        return d;
    }
    function sb(a) {
    ...
    function tb(a, b, c, d) {
        ...
        for (e in a) if (a.hasOwnProperty(e)) {
            ...
            f === g ? h.push(c) : (N(g) || l && f > g || n && g > f) && (h = [ c ], g = f);
        }
        x || (h = rb(h, 1));
        return d ? h : h[0];
    }
    function ub(a, b) {
        ...
        a = Cb(a, c, d);
        b = Cb(b, c, d);
        do c = a.charAt(f), e = l[c] || c, c = b.charAt(f), g = l[c] || c, c = e ? n.indexOf(e) : null, 
        d = g ? n.indexOf(g) : null, -1 === c || -1 === d ? (c = a.charCodeAt(f) || null, 
        d = b.charCodeAt(f) || null, x && (c >= Ea && Fa >= c || c >= Ga && Ha >= c) && (d >= Ea && Fa >= d || d >= Ga && Ha >= d) && (c = Oa(a.slice(f)), 
        d = Oa(b.slice(f)))) : (e = e !== a.charAt(f), g = g !== b.charAt(f), e !== g && 0 === h && (h = e - g)), 
        f += 1; while (null != c && null != d && c === d);
        return c === d ? h : c - d;
    }
    function Cb(a, b, c) {
        z(a) || (a = s(a));
    ...
    function Xb(a, b, c) {
        ...
        e = a.units[8 * (a.plural && g > 1 ? 1 : 0) + f] || a.units[f];
        a.capitalizeUnit && (e = Yb(e));
        d = a.modifiers.filter(function(a) {
            return "sign" == a.name && a.value == (h > 0 ? 1 : -1);
        })[0];
    ...
    function bc(a, b) {
        ...
        h.timeSuffixes.length > 0 && h.addFormat(Vb(h), !1, Jb);
        h.addFormat("{day}", !0);
    ...
    function ec(a) {
        var b, c = {};
        (a = a.match(/^(\d+)?\s?(\w+?)s?$/i)) && (N(b) && (b = parseInt(a[1]) || 1), c[a[2].toLowerCase()] = b);
        return c;
    }
    function fc(a, b, c) {
        var d;
        N(c) && (c = Ob.length);
        for (b = b || 0; c > b && (d = Ob[b], !1 !== a(d.name, d, b)); b++) ;
    }
    function gc(a, b) {
        var d, e, c = {};
        b.forEach(function(b, f) {
            d = a[f + 1];
            N(d) || "" === d || ("year" === b && (c.t = d.replace(/'/, "")), e = parseFloat(d.replace(/'/, "").replace(/,/, ".")), 
    ...
    function jc(a, b, c, d) {
        ...
        function h() {
            ...
            "year" === E ? k.e = "month" : ("month" === E || "week" === E) && (k.e = "day");
        ...
        function l() {
            ...
            fc(function(b, c, d) {
                "day" === b && (b = "date");
                if (M(k[b])) {
                    if (d >= wb) return n.setTime(0/0), !1;
                    a = a || {};
                    a[b] = k[b];
                    delete k[b];
                }
        ...
        vb = [];
        n.utc(d);
        C(a) ? n.utc(a.isUTC()).setTime(a.getTime()) : y(a) ? n.setTime(a) : G(a) ? (n.set(a, !0), 
        k = a) : z(a) && (ha = Y(b), a = hc(a), ha && I(ha.o ? [ ha.o ].concat(ha.g) : ha.g, function(c, d) {
            var g = a.match(d.q);
            if (g) {
                B = d.locale;
                k = gc(g, d.to);
                ...
                d.r && !z(k.month) && (z(k.date) || Zb(ha, b)) && (ca = k.month, k.month = k.date, 
                k.date = ca);
                ...
                k.day && (ca = B.i[k.day]) ? (k.day = ca.value, n.reset(), x = !0) : k.day && (Ba = B.getWeekday(k.day)) > -1 && (delete k.day, 
                ...
                ("offset_hours" in k || "offset_minutes" in k) && (n.utc(), k.offset_minutes = k.offset_minutes || 0, 
                k.offset_minutes += 60 * k.offset_hours, "-" === k.offset_sign && (k.offset_minutes *= -1), 
                k.minute -= k.offset_minutes);
                k.unit && (x = !0, ra = ac(B, k.num), wb = B.units.indexOf(k.unit) % 8, E = W.units[wb], 
                l(), k.shift && (ra *= (ca = B.i[k.shift]) ? ca.value : 0), k.sign && (ca = B.i[k.sign]) && (ra *= ca.value), 
                M(k.weekday) && (n.set({
                    weekday: k.weekday
        ...
        }), k ? x ? n.advance(k) : (n._utc && n.reset(), kc(n, k, !0, !1, c)) : ("now" !== a && (n = new r(a)), 
        d && n.addMinutes(-n.getTimezoneOffset())), g(), n.utc(!1));
        return {
            c: n,
            set: k
        };
    ...
    function mc(a) {
        ...
        (6 === b[1] || 5 === b[1] && 4 === b[0] && a.daysFromNow() >= cc().daysInMonth()) && (b[0] = P(a.monthsFromNow()), 
        b[1] = 6);
        return b;
    }
    function nc(a, b, c) {
    ...
    function qc(a, b, c, d) {
        ...
        if (!b && c) return e = e || mc(a), 0 === e[1] && (e[1] = 1, e[0] = 1), a = Y(d), 
        Xb(a, e, e[2] > 0 ? "future" : "past");
        b = b || "long";
        ("short" === b || "long" === b || "full" === b) && (b = Y(d)[b]);
        Qb[b] || pc(b);
        var g, f;
        e = "";
        b = Qb[b];
        g = 0;
        for (c = b.length; c > g; g++) f = b[g], e += F(f) ? f(a, d) : f;
        return e;
    }
    function rc(a, b, c, d, e) {
        ...
        if (g.set && g.set.e) {
            ...
            b = Yb(g.set.e);
            (g.set.edge || g.set.shift) && g.c["beginningOf" + b]();
    ...
    function kc(a, b, c, d, e) {
        ...
        Rb.forEach(function(c) {
            ...
            var h;
            h = g(e);
            N(h) || (d ? ("week" === e && (h = (b.day || 0) + 7 * h, c = "Date"), h = h * d + U(a, c)) : "month" === e && f("day") && Sa(a, "Date", 15), 
            Sa(a, c, h), d && "month" === e && (e = h, 0 > e && (e = e % 12 + 12), e % 12 != U(a, "Month") && Sa(a, "Date", 0)));
        });
        ...
        l && fc(function(b, c) {
            if ((c.k || "week" === b && f("weekday")) && !(f(b) || "day" === b && f("weekday"))) return a[c.j](e), 
            !1;
        }, h + 1);
        return a;
    }
    ...
    function Ac(a, b, c, d, e) {
        1/0 !== b && (a.timers || (a.timers = []), y(b) || (b = 1), a.n = !1, a.timers.push(setTimeout(function() {
            a.n || c.apply(d, e || []);
        }, b)));
    }
    ...
    function Ec(a, b, c, d) {
        var e, g, f;
        (g = b.match(/^(.+?)(\[.*\])$/)) ? (f = g[1], b = g[2].replace(/^\[|\]$/g, "").split("]["), 
    ...
    function Ic(a) {
        a = +a;
        if (0 > a || 1/0 === a) throw new RangeError("Invalid number");
        return a;
    }
    function Jc(a, b) {
        return Na(M(b) ? b : " ", a);
    ...
    function Kc(a, b, c, d, e) {
        var g;
        if (b >= a.length) return a.toString();
        d = N(d) ? "..." : d;
        switch (c) {
          case "left":
          ...
          case "middle":
            return c = Aa(b / 2), g = Q(b / 2), b = e ? Lc(a, c) : a.slice(0, c), a = e ? Lc(a, g, !0) : a.slice(a.length - g), 
            b + d + a;
    ...
    var La, Ea = 48, Fa = 57, Ga = 65296, Ha = 65305, Ia = ".", Ja = "", Ka = {};
    na(m);
    I(w, function(a, b) {
        na(ba[b]);
    });
    ...
    H(p, !0, !1, {
        ...
        map: function(a, b) {
            ...
            for (cb(arguments); c > d; ) d in this && (e[d] = a.call(b, this[d], d, this)), 
            d++;
            return e;
        },
        filter: function(a) {
            var b = arguments[1], c = this.length, d = 0, e = [];
            for (cb(arguments); c > d; ) d in this && a.call(b, this[d], d, this) && e.push(this[d]), 
            d++;
            return e;
        },
        ...
        forEach: function(a, b) {
            var c = this.length, d = 0;
            for (ta(a); c > d; ) d in this && a.call(b, this[d], d, this), d++;
        },
        reduce: function(a, b) {
            return bb(this, a, b);
        },
    ...
    H(Function, !0, !1, {
        bind: function(a) {
            var d, b = this, c = L(arguments, null, 1);
    ...
    H(p, !1, !0, {
        create: function() {
            ...
            L(arguments, function(b) {
                (!ua(b) && "length" in b && ("[object Arguments]" === v.call(b) || b.callee) || !ua(b) && "length" in b && !z(b) && !va(b)) && (b = p.prototype.slice.call(b, 0));
                a = a.concat(b);
            });
            return a;
        }
    ...
    H(p, !0, !0, {
        ...
        findAll: function(a, b, c) {
            var e, d = [];
            this.length > 0 && (e = ib(a), V(this, function(a, b, c) {
                e(a, b, c) && d.push(a);
            }, b, c));
            return d;
        },
        ...
        sum: function(a) {
            a = a ? this.map(a) : this;
            return a.length > 0 ? a.reduce(function(a, c) {
                return a + c;
            }) : 0;
        },
        average: function(a) {
        ...
        inGroups: function(a, b) {
            var c = arguments.length > 1, d = this, e = [], g = Aa(this.length / a);
            wa(a, function(a) {
                a *= g;
                var h = d.slice(a, a + g);
                c && g > h.length && wa(g - h.length, function() {
                    h = h.add(b);
                });
                e.push(h);
            });
        ...
        inGroupsOf: function(a, b) {
            var g, c = [], d = this.length, e = this;
            if (0 === d || 0 === a) return e;
            N(a) && (a = 1);
            N(b) && (b = null);
            wa(Aa(d / a), function(d) {
                for (g = e.slice(a * d, a * d + a); a > g.length; ) g.push(b);
                c.push(g);
            });
            return c;
        },
        ...
        sortBy: function(a, b) {
            ...
            c.sort(function(d, e) {
                ...
                g = kb(d, a, c, [ d ]);
                f = kb(e, a, c, [ e ]);
                return (z(g) && z(f) ? ub(g, f) : f > g ? -1 : g > f ? 1 : 0) * (b ? -1 : 1);
            });
            return c;
        },
        randomize: function() {
            for (var c, d, a = this.concat(), b = a.length; b; ) c = 0 | u.random() * b, d = a[--b], 
            a[b] = a[c], a[c] = d;
            return a;
        },
        zip: function() {
        ...
        remove: function() {
            ...
            L(arguments, function(b) {
                var c = 0;
                for (b = ib(b); a.length > c; ) b(a[c], c, a) ? a.splice(c, 1) : c++;
            });
            return a;
        },
        compact: function(a) {
    ...
    "use strict";
    var W, Ib, Mb, Nb, Ob, Jb = "ampm hour minute second ampm utc offset_sign offset_hours offset_minutes ampm".split(" "), Kb = "({t})?\\s*(\\d{1,2}(?:[,.]\\d+)?)(?:{h}([0-5]\\d(?:[,.]\\d+)?)?{m}(?::?([0-5]\\d(?:[,.]\\d+)?){s})?\\s*(?:({t})|(Z)|(?:([+-])(\\d{2,2})(?::?(\\d{2,2}))?)?)?|\\s*({t}))", Lb = {}, Pb = [], Qb = {}, X = {
        yyyy: function(a) {
            return U(a, "FullYear");
        },
        yy: function(a) {
        ...
        k: !0,
        b: function(a) {
            return 864e5 * (365 + (a ? a.isLeapYear() ? 1 : 0 : .25));
        }
    }, {
        name: "month",
        error: .919,
        ...
        b: function(a, b) {
            var d, c = 30.4375;
            a && (d = a.daysInMonth(), d.days() >= b && (c = d));
            return 864e5 * c;
        }
    }, {
        name: "week",
    ...
    Tb.prototype = {
        ...
        addFormat: function(a, b, c, d, e) {
            ...
            a = a.replace(/\{([^,]+?)\}/g, function(a, b) {
                ...
                h ? d = f.tokens[h[1]] : f[E] ? d = f[E] : f[E + "s"] && (d = f[E + "s"], k && (e = [], 
                d.forEach(function(a, b) {
                    var c = b % (f.units ? 8 : d.length);
                    c >= k[1] && (k[2] || k[1]) >= c && e.push(a);
                }), d = e), d = Ub(d));
                h ? h = "(?:" + d + ")" : (c || g.push(E), h = "(" + d + ")");
                B && (h += "?");
                return h;
            });
            b ? (b = Vb(f, e), e = [ "t", "[\\s\\u3000]" ].concat(f.timeMarker), h = a.match(/\\d\{\d,\d\}\)+\??$/), 
            Wb(f, "(?:" + b + ")[,\\s\\u3000]+?" + a, Jb.concat(g), d), Wb(f, a + "(?:[,\\s]*(?:" + e.join("|") + (h ? "+" : "*") + ")" + b + ")?", g.concat(Jb), d)) : Wb(f, a, g, d);
        }
    };
    H(r, !1, !0, {
        create: function() {
        ...
        is: function(a, b, c) {
            ...
            if (this.isValid()) {
                if (z(a)) switch (a = a.trim().toLowerCase(), e = this.clone().utc(c), !0) {
                  ...
                  case "weekday" === a:
                    return U(e, "Day") > 0 && 6 > U(e, "Day");

                  case "weekend" === a:
                    return 0 === U(e, "Day") || 6 === U(e, "Day");

                  case (d = W.weekdays.indexOf(a) % 7) > -1:
                    return U(e, "Day") === d;

                  case (d = W.months.indexOf(a) % 12) > -1:
                    return U(e, "Month") === d;
                }
    ...
    K(r, !0, !0, Rb, function(a, b, c) {
        function d(a) {
            a /= f;
            var c = a % 1, d = b.error || .999;
            c && P(c % 1) > d && (a = R(a));
            return 0 > a ? Aa(a) : Q(a);
        }
        var h, l, e = b.name, g = Yb(e), f = b.b();
        b.j = "add" + g + "s";
        h = function(a, b) {
    ...
    H(Range, !0, !0, {
        ...
        span: function() {
            return this.isValid() ? P((z(this.end) ? this.end.charCodeAt(0) : this.end) - (z(this.start) ? this.start.charCodeAt(0) : this.start)) + 1 : 0/0;
        },
        contains: function(a) {
            return null == a ? !1 : a.start && a.end ? a.start >= this.start && a.start <= this.end && a.end >= this.start && a.end <= this.end : a >= this.start && this.end >= a;
        },
        every: function(a, b) {
            var c, d = this.start, e = this.end, g = d > e, f = d, h = 0, l = [];
            F(a) && (b = a, a = null);
            a = a || 1;
            y(d) ? c = zc : z(d) ? c = yc : C(d) && (c = a, y(c) ? a = c : (d = c.toLowerCase().match(/^(\d+)?\s?(\w+?)s?$/i), 
            c = parseInt(d[1]) || 1, d = d[2].slice(0, 1).toUpperCase() + d[2].slice(1), d.match(/hour|minute|second/i) ? d += "s" : "Year" === d ? d = "FullYear" : "Day" === d && (d = "Date"), 
            a = [ c, d ]), c = xc);
            for (g && a > 0 && (a *= -1); g ? f >= e : e >= f; ) l.push(f), b && b(f, h), f = c(f, a), 
            h++;
            return l;
        },
        union: function(a) {
        ...
        intersect: function(a) {
            return a.start > this.end || a.end < this.start ? new Range(0/0, 0/0) : new Range(this.start > a.start ? this.start : a.start, this.end < a.end ? this.end : a.end);
        },
        clone: function() {
            return new Range(this.start, this.end);
        },
        clamp: function(a) {
            var b = this.start, c = this.end, d = b > c ? c : b, b = b > c ? b : c;
            return vc(d > a ? d : a > b ? b : a);
        }
    });
    ...
    H(Function, !0, !0, {
        lazy: function(a, b, c) {
            function d() {
                c - (f && b ? 1 : 0) > g.length && g.push([ this, arguments ]);
                f || (f = !0, b ? h() : Ac(d, l, h));
                return x;
            }
            var h, l, n, x, e = this, g = [], f = !1;
            a = a || 1;
            c = c || 1/0;
            l = Aa(a);
            n = R(l / a) || 1;
            h = function() {
                var b, a = g.length;
                if (0 != a) {
                    for (b = S(a - n, 0); a > b; ) x = Function.prototype.apply.apply(e, g.shift()), 
                    a--;
                    Ac(d, l, function() {
                        f = !1;
                        h();
        ...
        every: function(a) {
            ...
            var c = this, d = arguments, d = d.length > 1 ? L(d, null, 1) : [];
            Ac(c, a, b);
            return c;
        },
        cancel: function() {
    ...
    H(t, !0, !0, {
        ...
        format: function(a, b, c) {
            ...
            e = d[0];
            g = d[1];
            for (d = e.length; d > 0; d -= 3) e.length > d && (f = b + f), f = e.slice(S(0, d - 3), d) + f;
        ...
        times: function(a) {
            if (a) for (var b = 0; this > b; b++) a.call(this, b);
    ...
    H(m, !1, !0, {
        ...
        merge: function(a, b, c, d) {
            ...
            if (a && "string" != typeof b) for (e in b) if (J(b, e) && a) {
                ...
                if (c && (g || f)) if (C(h)) x = new r(h.getTime()); else {
                    if (!D(h)) {
                        f || (a[e] = p.isArray(h) ? [] : {});
                        m.merge(a[e], h, c, d);
                        continue;
                    }
                    x = new q(h.source, Qa(h));
                }
                a[e] = x;
            }
            return a;
        ...
        clone: function(a, b) {
            ...
            if (a instanceof O) c = new O(); else if (A(a, c)) c = []; else {
                if (!va(a, c)) throw new TypeError("Clone must be a basic data type.");
                c = {};
            }
    ...
    H(s, !0, !0, {
        ...
        each: function(a, b) {
            ...
            c = this.match(a) || [];
            if (b) for (d = 0, e = c.length; e > d; d++) c[d] = b.call(this, c[d], d, c) || c[d];
            return c;
        },
        shift: function(a) {
            var b = "";
        ...
        stripTags: function() {
            var a = this;
            sa(arguments.length > 0 ? arguments : [ "" ], function(b) {
        ...
        removeTags: function() {
            var a = this;
            sa(arguments.length > 0 ? arguments : [ "\\S+" ], function(b) {
                b = q("<(" + b + ")[^<>]*(?:\\/>|>.*?<\\/\\1>)", "gi");
                a = a.replace(b, "");
            });
            return a;
    ...
    (function(a) {
        if (ba.btoa) Nc = ba.btoa, Oc = ba.atob; else {
            var b = /[^A-Za-z0-9\+\/\=]/g;
            Nc = function(b) {
                var e, g, f, h, l, n, d = "", x = 0;
                do e = b.charCodeAt(x++), g = b.charCodeAt(x++), f = b.charCodeAt(x++), h = e >> 2, 
                e = (3 & e) << 4 | g >> 4, l = (15 & g) << 2 | f >> 6, n = 63 & f, isNaN(g) ? l = n = 64 : isNaN(f) && (n = 64), 
                d = d + a.charAt(h) + a.charAt(e) + a.charAt(l) + a.charAt(n); while (b.length > x);
                return d;
            };
            Oc = function(c) {
                var e, g, f, h, l, d = "", n = 0;
                ...
                do e = a.indexOf(c.charAt(n++)), g = a.indexOf(c.charAt(n++)), h = a.indexOf(c.charAt(n++)), 
                l = a.indexOf(c.charAt(n++)), e = e << 2 | g >> 4, g = (15 & g) << 4 | h >> 2, f = (3 & h) << 6 | l, 
                d += s.fromCharCode(e), 64 != h && (d += s.fromCharCode(g)), 64 != l && (d += s.fromCharCode(f)); while (c.length > n);
                return d;
            };
        }
